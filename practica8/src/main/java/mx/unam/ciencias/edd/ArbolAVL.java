...
public class ArbolAVL<T extends Comparable<T>> extends ArbolBinarioOrdenado<T> {
    ...
    public void agrega(T elemento) {
        ...
        VerticeAVL vertice = (VerticeAVL) super.getUltimoVerticeAgregado();
    ...
    public void elimina(T elemento) {
        ...
        if (elementos == 0) {
            ...
            VerticeAVL v = verticeAVL(intercambiaEliminable(V));
            eliminaVertice(v);
    ...
    private int balance(VerticeAVL v) {
        ...
        if (v.hayIzquierdo() && v.hayDerecho())
            altura = v.izquierdo().altura() - v.derecho().altura();
        else if (!v.hayIzquierdo() && v.hayDerecho())
            altura = -1 - v.derecho().altura();
        else if (v.hayIzquierdo() && !v.hayDerecho())
            altura = v.izquierdo().altura() + 1;
        else
            altura = 0;
