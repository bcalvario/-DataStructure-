...
public class ArbolRojinegroSVG implements ArbolSVG {

	public ArbolRojinegro<Integer> a;
	public VerticeArbolBinario<Integer> raizIzquierdo;
	public VerticeArbolBinario<Integer> raizDerecho;

	ArbolRojinegroSVG(Coleccion<Integer> coleccion){
        a = (ArbolRojinegro<Integer>) coleccion;
		if (a.getElementos() > 1) {
