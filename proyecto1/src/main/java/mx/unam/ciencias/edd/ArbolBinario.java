...
public abstract class ArbolBinario<T> implements Coleccion<T> {
    ...
    protected class Vertice implements VerticeArbolBinario<T> {
         ...
         */
        @Override
        public int altura() { // la altura es el caminos más largo donde comienza el nodo y y ter
            int izquierdoAux = -1;
            int derechoAux = -1;
            if (hayDerecho())
        ...
        public boolean equals(Object objeto) {
            ...
            return raiz.elemento.equals(vertice.elemento) && equals(raiz.izquierdo, vertice.izquierdo) && equals(raiz.derecho, vertice.derecho);
        }
        private boolean equals(Vertice izquierdo, Vertice derecho) {
            if (izquierdo == null && derecho == null)
                ...
                return false;
            return izquierdo.elemento.equals(derecho.elemento) && equals(izquierdo.izquierdo, derecho.izquierdo) && equals(izquierdo.derecho, derecho.derecho);
        }
