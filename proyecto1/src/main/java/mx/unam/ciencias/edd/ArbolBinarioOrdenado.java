...
public class ArbolBinarioOrdenado<T extends Comparable<T>> extends ArbolBinario<T> {
    ...
    public void elimina(T elemento) {
        ...
        elementos--;
        if (!vertice.hayIzquierdo() && vertice.hayDerecho() || vertice.hayIzquierdo() && !vertice.hayDerecho() || !vertice.hayDerecho() && !vertice.hayIzquierdo()) {
    ...
    protected Vertice intercambiaEliminable(Vertice vertice) {
        Vertice verticeDescendiente = vertice.izquierdo;
        while (verticeDescendiente.hayDerecho())
            verticeDescendiente = verticeDescendiente.derecho;
        return verticeDescendiente;
    }
